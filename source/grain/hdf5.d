...
//         string filename;
//         this~{
//             H5Fclose(this.filename.toStringz);
//         }
//         @disable this(this);
//         @disable new(size_t);
//     };

//     auto fileCreate(string filename, uint flags, hid_t create_plist, hid_t access_plist) {
//         H5Fcreate(file.toStringz, flags, create_plist, access_plist);
//         return H5F(filename);
//     }
// }
